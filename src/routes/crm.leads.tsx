...
function LeadsPage() {
  ...
  const completedLeads = leads.filter((l) => l.status === "in process" || l.status === "Confirmed" || l.status === "Payment Pending").length;
                                      ...
                                      if (tableEditNoteText.trim()) {
                                        ...
                                        const newLeads = leads.map((x) => {
                                          if (x.id === l.id) {
                                            ...
                                            // Explicitly update Supabase
                                            supabase.from("leads").update(updates).eq("id", l.id).then(({ error }) => {
