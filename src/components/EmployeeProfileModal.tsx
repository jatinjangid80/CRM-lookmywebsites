...
export function EmployeeProfileModal({ 
  ...
  const handleSaveCredentials = () => {
    ...
    if (credPassword.length < 4) { setCredError("Password must be at least 4 characters."); return; }
    ...
    try {
      ...
      if (idx !== -1) {
        ...
        list.push({ id: employee.id, name: employee.name, username: credUsername.trim(), password: credPassword });
      }
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-5xl h-[92vh] overflow-y-auto p-0 gap-0 bg-[#F9FAFB] text-[#111827]">
          ...
          <DialogDescription className="sr-only">Redesigned modern Company CRM Employee Profile for {employee.name}.</DialogDescription>
        ...
        <div className="p-6 md:p-8 space-y-6">
              ...
              {isEditing && editDetails ? (
                ...
                <div className="text-center md:text-left space-y-1">
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5">
                    <h2 className="text-2xl font-bold font-display text-gray-900">{employee.name}</h2>
                    <span className={`rounded-full border px-2.5 py-0.5 text-xs font-semibold ${STATUS_COLOR[employee.status as keyof typeof STATUS_COLOR] || "bg-slate-100"}`}>
                      {employee.status}
                    </span>
                  </div>
                  <p className="text-[#FF6B00] font-semibold text-sm">{employee.role} • {empDetails.department}</p>
                ...
                <div className="space-y-3 pt-1">
                  ...
                  {credUsername ? (
                    <div className="rounded-xl bg-purple-50 border border-purple-100 px-3 py-2.5 flex items-center justify-between">
                      <div>
                        <p className="text-[10px] font-bold text-purple-500 uppercase tracking-wider">Current Login</p>
                    ...
                    <div className="rounded-xl bg-amber-50 border border-amber-100 px-3 py-2.5">
                      <p className="text-[11px] text-amber-700 font-medium">No credentials set yet.</p>
                    </div>
                  )}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      >
                        {showCredPass ? <EyeOff className="h-3.5 w-3.5" /> : <Eye className="h-3.5 w-3.5" />}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between items-center py-1.5 pt-1.5">
                      ...
                      <span className={`inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full border ${
                        empDetails.verificationStatus === "Verified" ? "text-emerald-600 bg-emerald-50 border-emerald-200" : "text-amber-600 bg-amber-50 border-amber-200"
                      }`}>
            ...
            <div className="space-y-6 md:col-span-2">
                ...
                {isEditing && editDetails ? (
                    ...
                    <div className="space-y-2.5">
                      ...
                      <div className="space-y-1">
                        ...
                        <textarea 
                          ...
                          onChange={(e) => setEditDetails({...editDetails, bio: e.target.value})} 
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 text-sm">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2 py-1.5"><span className="text-muted-foreground text-xs font-medium">About / Bio</span><span className="col-span-2 text-gray-700 leading-relaxed font-medium">{employee.description || "Active system user."}</span></div>
                    </div>
                  </div>
                )}
              </Card>
              ...
              <Card title="Contact Information">
                {isEditing && editDetails ? (
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 text-sm">
                    <div className="space-y-2">
                      <div className="grid grid-cols-3 gap-2 py-1.5 border-b border-gray-100"><span className="text-muted-foreground text-xs font-medium">Work Phone</span><span className="col-span-2 font-semibold text-gray-800">{employee.phone}</span></div>
                      ...
                      <div className="grid grid-cols-3 gap-2 py-1.5 border-b border-gray-100"><span className="text-muted-foreground text-xs font-medium">Work Email</span><span className="col-span-2 font-semibold text-gray-800">{employee.email}</span></div>
          ...
          <div className="space-y-6">
            ...
            <Card title="Career History">
                    ...
                    {isEditing && editDetails ? (
                      editDetails.careerHistory.map((h, i) => (
                        <tr key={i} className="hover:bg-orange-50/10 transition-colors">
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={h.company} onChange={(e) => updateCareer(i, "company", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={h.position} onChange={(e) => updateCareer(i, "position", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" type="date" value={h.startDate} onChange={(e) => updateCareer(i, "startDate", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" type="date" value={h.endDate} onChange={(e) => updateCareer(i, "endDate", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={h.responsibilities} onChange={(e) => updateCareer(i, "responsibilities", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={h.achievement} onChange={(e) => updateCareer(i, "achievement", e.target.value)} /></td>
                          <td className="px-2 py-1.5 text-right">
                            <Button size="icon" variant="ghost" className="h-7 w-7 text-red-600 hover:text-red-700 hover:bg-red-50" onClick={() => deleteCareer(i)}>
              ...
              {isEditing && (
                <div className="pt-2 text-right">
                  <Button variant="outline" size="sm" className="text-[#FF6B00] border-[#FF6B00]/30 hover:bg-orange-50 text-xs" onClick={addCareer}>
            ...
            <Card title="Academic Background">
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700 bg-white">
                    {isEditing && editDetails ? (
                      editDetails.academicBackground.map((a, i) => (
                        <tr key={i} className="hover:bg-orange-50/10 transition-colors">
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={a.institution} onChange={(e) => updateAcademic(i, "institution", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={a.qualification} onChange={(e) => updateAcademic(i, "qualification", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={a.specialization} onChange={(e) => updateAcademic(i, "specialization", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={a.year} onChange={(e) => updateAcademic(i, "year", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={a.grade} onChange={(e) => updateAcademic(i, "grade", e.target.value)} /></td>
                          <td className="px-2 py-1.5 text-right">
                            <Button size="icon" variant="ghost" className="h-7 w-7 text-red-600 hover:text-red-700 hover:bg-red-50" onClick={() => deleteAcademic(i)}>
                              <Trash2 className="h-3.5 w-3.5" />
                            </Button>
                          </td>
                        </tr>
              ...
              {isEditing && (
                <div className="pt-2 text-right">
                  <Button variant="outline" size="sm" className="text-[#FF6B00] border-[#FF6B00]/30 hover:bg-orange-50 text-xs" onClick={addAcademic}>
            ...
            <Card title="Family Information">
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700 bg-white">
                    {isEditing && editDetails ? (
                      editDetails.familyInformation.map((f, i) => (
                        <tr key={i} className="hover:bg-orange-50/10 transition-colors">
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={f.name} onChange={(e) => updateFamily(i, "name", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={f.relationship} onChange={(e) => updateFamily(i, "relationship", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" type="date" value={f.dob} onChange={(e) => updateFamily(i, "dob", e.target.value)} /></td>
                          <td className="px-2 py-1.5"><Input className="h-7 text-xs" value={f.contactNumber} onChange={(e) => updateFamily(i, "contactNumber", e.target.value)} /></td>
                          <td className="px-2 py-1.5 text-right">
                            <Button size="icon" variant="ghost" className="h-7 w-7 text-red-600 hover:text-red-700 hover:bg-red-50" onClick={() => deleteFamily(i)}>
                              <Trash2 className="h-3.5 w-3.5" />
                            </Button>
                          </td>
                        </tr>
              ...
              {isEditing && (
                <div className="pt-2 text-right">
                  <Button variant="outline" size="sm" className="text-[#FF6B00] border-[#FF6B00]/30 hover:bg-orange-50 text-xs" onClick={addFamily}>
                    ...
                    <div key={rec} className="border-b last:border-b-0 border-gray-100">
                      ...
                      {isExpanded && (
                        <div className="bg-gray-50/50 p-4 border-t border-gray-100 space-y-4 animate-in slide-in-from-top-1 duration-150">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                      {empAtt.map(a => (
                                        <tr key={a.id} className="hover:bg-gray-50">
                                          ...
                                          <td className="p-2.5">
                                            <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                                              a.status === "Present" ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-red-50 text-red-700 border border-red-100"
                                            }`}>{a.status}</span>
                                          </td>
                                          <td className="p-2.5 text-right">
                                            <Button 
                          ...
                          {/* DOCUMENTS */}
                          {rec === "Documents" && (() => {
                            const empDocs = hrFiles.filter(d => d.empId === employee.id || !d.empId); // General handbook or user files
                            return (
                              <div className="space-y-3">
                                <div className="overflow-x-auto border border-gray-200 rounded-lg bg-white">
                                  <table className="w-full text-left text-xs">
      ...
      <Dialog open={showCredModal} onOpenChange={setShowCredModal}>
        <DialogContent className="max-w-sm" aria-describedby="cred-modal-desc">
          ...
          <DialogDescription id="cred-modal-desc" className="text-xs text-muted-foreground">
            Assign a username and password so <span className="font-semibold text-gray-800">{employee.name}</span> can log in to the CRM portal.
          </DialogDescription>
          <div className="mt-2 space-y-4">
            ...
            <p className="text-[10px] text-muted-foreground text-center pt-1 border-t border-gray-100">
              Employee ID: <span className="font-mono font-semibold">{employee.id}</span> · Role: <span className="font-semibold">{employee.role}</span>
            </p>
          </div>
        </DialogContent>
      </Dialog>
