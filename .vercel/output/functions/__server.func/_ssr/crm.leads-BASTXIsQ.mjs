...
import { C as Search, Ct as ChevronUp, Et as Check, F as MapPin, I as Mail, K as IndianRupee, N as Package, Nt as Building2, O as Phone, Pt as Briefcase, T as Plus, Tt as ChevronDown, V as LayoutGrid, X as Globe, Z as Funnel, b as Sparkles, ft as Download, h as Table2, i as User, kt as CalendarDays, n as X, o as UserCheck, r as Users, rt as FileText, s as Upload, u as TrendingUp, wt as ChevronRight, x as Shield, xt as CircleAlert } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/crm.leads-BASTXIsQ.js
...
function AddLeadModal({ onClose, onAdd, existingLeads }) {
	...
	const submit = () => {
		...
		onAdd({
			...
			totalAmount: form.totalAmount ? Number(form.totalAmount) : void 0,
			amountPaid: form.amountPaid ? Number(form.amountPaid) : void 0,
			vendorName: form.vendorName || void 0
		});
	};
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						["Booked", "Completed"].includes(form.status) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "sm:col-span-2 grid gap-4 rounded-xl border border-border p-4 bg-secondary/30 sm:grid-cols-3",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									className: "mb-1.5 block text-sm font-semibold",
...
function LeadDetail({ lead, onClose, onStatusChange, onDelete, isAdmin, onEditNote, onUpdateLead }) {
	...
	const [isEditingBooking, setIsEditingBooking] = (0, import_react.useState)(false);
	const [bookingDetails, setBookingDetails] = (0, import_react.useState)({
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(lead.status === "Booked" || lead.status === "Completed" || lead.bookingReference || isEditingBooking) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), isAdmin && onUpdateLead && !isEditingBooking && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setIsEditingBooking(true),
									className: "text-[10px] text-blue-500 hover:underline",
									children: "Edit Details"
								})]
							}), isEditingBooking ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-2xl border border-border bg-secondary/30 p-4 space-y-4 animate-in fade-in",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-3",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								...
								className: "rounded-2xl border border-border p-4 space-y-3 bg-secondary/10",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											className: "text-xs font-medium mt-0.5",
											children: lead.bookingReference || "—"
										})] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												...
												className: "text-xs font-medium mt-0.5",
												children: lead.hotelDetails || "—"
											})]
										})
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "border-t border-border pt-3 mt-1 grid grid-cols-3 gap-2",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[10px] font-semibold text-muted-foreground uppercase",
											children: "Total"
											...
											children: formatINR(lead.totalAmount || 0)
										})] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[10px] font-semibold text-muted-foreground uppercase",
											children: "Paid"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-xs font-semibold text-emerald-600 mt-0.5",
											children: formatINR(lead.amountPaid || 0)
										})] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[10px] font-semibold text-muted-foreground uppercase",
											children: "Status"
											...
											className: "mt-1",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: `inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider ${lead.paymentStatus === "Paid" ? "bg-emerald-100 text-emerald-700" : lead.paymentStatus === "Partial" ? "bg-amber-100 text-amber-700" : "bg-rose-100 text-rose-700"}`,
												children: lead.paymentStatus || "Pending"
											})
										})] })
									]
								})]
...
function LeadsPage() {
	...
	const exportToPDF = () => {
		...
		const bodyHtml = `<h2>Grand Journeys CRM - Leads Export</h2><p>Generated on ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-IN")} | Total Leads: ${filtered.length}</p><table><thead>${tableHeader}</thead><tbody>${tableRows}</tbody></table>`;
	...
	const handleImportLeads = (data) => {
		...
		const importedLeads = data.map((row, idx) => ({
			...
			travelDate: String(row["Travel Date"] || row["travelDate"] || (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)),
