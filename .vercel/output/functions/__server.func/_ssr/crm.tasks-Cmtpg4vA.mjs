...
import { At as CalendarDays, B as ListChecks, E as Plus, L as Mail, Q as Funnel, St as CircleAlert, _t as Clock, b as Sparkles, bt as CircleCheck, f as Trash2, ht as CreditCard, it as FileText, k as Phone, n as X, vt as Circle } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/crm.tasks-Cmtpg4vA.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var TASKS_LS_KEY = "crm_tasks_v1";
function loadTasks() {
	try {
...
var SEED = [
	{
		id: "T-001",
		title: "Call Ananya re: Bali visa docs",
		type: "Call",
		priority: "High",
		assignee: "Riya Bansal",
		dueDate: "2026-06-20",
		status: "Pending",
		note: "She needs visa guidance before July",
		lead: "Ananya Verma"
	},
	{
		id: "T-002",
		title: "Send Maldives quote to Neha Kapoor",
		type: "Email",
		priority: "High",
		assignee: "Riya Bansal",
		dueDate: "2026-06-19",
		status: "Pending",
		note: "Upgrade to water villa",
		lead: "Neha Kapoor"
	},
	{
		id: "T-003",
		title: "Collect 50% advance from Rohan Mehta",
		type: "Payment",
		priority: "High",
		assignee: "Amit Shah",
		dueDate: "2026-06-21",
		status: "Pending",
		note: "Europe trip booked, advance pending",
		lead: "Rohan Mehta"
	},
	{
		id: "T-004",
		title: "Follow up with Aditya — Europe interest",
		type: "Follow-up",
		priority: "Medium",
		assignee: "Pooja Nair",
		dueDate: "2026-06-22",
	...
	{
		id: "T-005",
		title: "Send Sneha Thailand itinerary PDF",
		type: "Document",
		priority: "Medium",
		assignee: "Riya Bansal",
		dueDate: "2026-06-23",
		status: "Pending",
		note: "Thailand Island Hopper 8D/7N",
		lead: "Sneha Joshi"
	},
	{
		id: "T-006",
		title: "Confirm Dubai hotel for Divya Bhatt",
		type: "Call",
		priority: "Medium",
		assignee: "Rahul Gupta",
		dueDate: "2026-06-18",
		status: "Done",
		note: "Address Beach Resort confirmed",
		lead: "Divya Bhatt"
	},
	{
		id: "T-007",
		title: "Send payment receipt to Priya Sharma",
		type: "Email",
		priority: "Low",
		assignee: "Riya Bansal",
		dueDate: "2026-06-17",
