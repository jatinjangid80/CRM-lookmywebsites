//#region node_modules/.nitro/vite/services/ssr/assets/employee-profile-defaults-wd6GGcin.js
var INITIAL_EMPLOYEE_DETAILS = {
	"LMH-01": {
		department: "HR & Admin",
		...
		directReports: [
			"Nikita Bairwa (LMH-02)",
			"Pushplata Kriplani (LMH-03)",
			"AMAN SHARMA (LMH-04)",
			"Deepak Kumar (LMH-05)"
		],
		dob: "1993-07-09",
		...
		careerHistory: [{
			company: "IDEA",
			position: "Tele-calling Executive",
			startDate: "2015-01-01",
			endDate: "2016-05-31",
			responsibilities: "Sold mobile plans and add-ons over calls",
			achievement: "Recognized as Top Closer in Q3 2015"
		}, {
			company: "NIMT Global Institute",
			position: "Tele-calling Executive",
			startDate: "2012-01-01",
			endDate: "2014-12-31",
			responsibilities: "Handled inbound and outbound customer inquiries",
			achievement: "Consistently exceeded weekly call quotas by 15%"
		}],
		academicBackground: [{
			...
			year: "2013",
			grade: "First Division (62%)"
		}],
		familyInformation: [{
			name: "Rajesh Yadav",
			relationship: "Husband",
			dob: "1990-12-12",
			contactNumber: "+91 98871XXXXX"
		}]
	},
	"LMH-02": {
		...
		verificationStatus: "Verified",
		careerHistory: [{
			company: "Jaipur Travels Ltd",
			position: "Junior Sales Agent",
			startDate: "2023-01-10",
			endDate: "2024-02-28",
			responsibilities: "Handled domestic holiday inquiries",
			achievement: "Closed highest domestic packages in Q2 2023"
		}],
		academicBackground: [{
			institution: "Rajasthan University",
			qualification: "B.Com",
			...
			year: "2017",
			grade: "Second Division (58%)"
		}],
		familyInformation: [{
			name: "Ram Bairwa",
			relationship: "Father",
			dob: "1968-04-10",
			contactNumber: "+91 99823XXXXX"
		}]
	},
	"LMH-03": {
		...
		verificationStatus: "Verified",
		careerHistory: [{
			company: "SBI Credit Cards",
			position: "Sales Agent",
			startDate: "2016-06-01",
			endDate: "2016-12-31",
			responsibilities: "Pitched and processed credit card application forms",
			achievement: "Cleared audit file verifications with zero errors"
		}],
		academicBackground: [{
			institution: "Rajasthan University",
			qualification: "B.A.",
			...
			year: "2016",
			grade: "First Division (61%)"
		}],
		familyInformation: [{
			name: "Harish Kriplani",
			relationship: "Father",
			dob: "1965-08-15",
			contactNumber: "+91 94140XXXXX"
		}]
	},
	"LMH-04": {
		...
		careerHistory: [{
			...
			endDate: "2021-10-30",
			responsibilities: "Managed day-to-day accounts bookkeeping",
			achievement: "Implemented GST portal filing structure"
		}],
		academicBackground: [{
			institution: "ICA",
			qualification: "Chartered Accountant (Inter)",
			specialization: "Commerce",
			year: "2017",
			grade: "Cleared Group 1"
		}, {
			institution: "Rajasthan University",
			qualification: "B.Com",
			specialization: "Commerce",
			year: "2013",
			grade: "First Division (65%)"
		}],
		familyInformation: [{
			name: "Pooja Sharma",
			relationship: "Wife",
			dob: "1993-09-18",
			contactNumber: "+91 98290XXXXX"
		}]
	},
	"LMH-05": {
		department: "Operations",
		...
		verificationStatus: "Verified",
		careerHistory: [{
			company: "LookMyHolidays",
			position: "Intern (Visa)",
			startDate: "2023-08-12",
			endDate: "2024-02-12",
			responsibilities: "Verified customer visa documents",
			achievement: "Promoted to Full-time Executive within 6 months"
		}],
		academicBackground: [{
			institution: "Rajasthan University",
			qualification: "B.Sc",
		...
		familyInformation: [{
			...
			dob: "1999-05-14",
			contactNumber: "+91 90011XXXXX"
		}]
	}
};
function createDefaultEmployeeDetails(empId, name, role, email, phone) {
	return {
		department: "Operations",
		designation: role,
		employmentType: "Permanent",
...
//#endregion
export { createDefaultEmployeeDetails as n, INITIAL_EMPLOYEE_DETAILS as t };
